...
<h2>Step 5. Confirming the Submission</h2>
            <div id="content">
               <ul class="steplist">
                  ...
                  <li id="step4" ><a href="https://iptek.its.ac.id/index.php/itj/author/submit/4?articleId=12536">4. Upload Supplementary Files</a></li>
               ...
               <form method="post" action="https://iptek.its.ac.id/index.php/itj/author/saveSubmit/5">
                  ...
                  <table class="listing" width="100%">
                     ...
                     <tr valign="top">
                        <td>31574</td>
                        <td><a class="file" href="https://iptek.its.ac.id/index.php/itj/author/download/12536/31574">12515-31518-1-SM.pdf</a></td>
                  ...
                  <p><input type="submit" value="Finish Submission" class="button defaultButton" /> <input type="button" value="Cancel" class="button" onclick="confirmAction('https://iptek.its.ac.id/index.php/itj/author', 'You can complete this submission at a later date by selecting Active Submissions from the Author home.')" /></p>
               </form>
            </div>
