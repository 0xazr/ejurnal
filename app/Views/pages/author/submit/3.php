            ...
            <div id="content">
               ...
               <form id="submit" method="post" action="/author/saveSubmit/3">
                  ...
                  <div id="authors">
                     ...
                     <input type="hidden" name="authors[0][authorId]" value="23892" />
                     ...
                     <table width="100%" class="data">
                        ...
                        <tr valign="top">
                           ...
                           <td width="80%" class="value"><input type="text" class="textField" name="authors[0][middleName]" id="authors-0-middleName" value="" size="20" maxlength="40" /></td>
                        </tr>
                        <tr valign="top">
                           <td width="20%" class="label">
